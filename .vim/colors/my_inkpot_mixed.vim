...
if has("gui_running")
    ...
    exec "hi LineNr         cterm=NONE   ctermfg=" . <SID>X(18) . " ctermbg=" . <SID>X(16)
"    exec "hi LineNr         cterm=NONE   ctermfg=" . <SID>X(39) . " ctermbg=" . <SID>X(16)
"    exec "hi LineNr         cterm=NONE   ctermfg=" . <SID>X(27) . " ctermbg=" . <SID>X(16)
    " The @s at lines that do not have text
    exec "hi NonText        cterm=BOLD   ctermfg=" . <SID>X(39) . " ctermbg=" . "NONE"
"    exec "hi SpecialKey     cterm=BOLD   ctermfg=" . <SID>X(55) . " ctermbg=" . "NONE"
    exec "hi SpecialKey     cterm=BOLD   ctermfg=" . <SID>X(8) . " ctermbg=" . "NONE"
    exec "hi Title          cterm=BOLD   ctermfg=" . <SID>X(48) . " ctermbg=" . "NONE"
    exec "hi Visual         cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(38)

"    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(18) . " ctermbg=" . "NONE"
    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(39) . " ctermbg=" . "NONE"
    exec "hi otlTab1        cterm=NONE   ctermfg=" . <SID>X(39) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(67) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=" . <SID>X( 7) . " ctermbg=" . <SID>X(81)
    ...
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(68) . " ctermbg=" . "NONE"
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(51) . " ctermbg=" . "NONE"
    ...
    exec "hi Access	    cterm=NONE   ctermfg=" . <SID>X(52) . " ctermbg=" . "NONE"
    exec "hi Cast	    cterm=NONE   ctermfg=" . <SID>X(41) . " ctermbg=" . "NONE"
    exec "hi PreCondit	    cterm=NONE   ctermfg=" . <SID>X(51) . " ctermbg=" . "NONE"
    exec "hi makeDString    cterm=NONE   ctermfg=" . <SID>X(41) . " ctermbg=" . "NONE"
    exec "hi makeSString    cterm=NONE   ctermfg=" . <SID>X(42) . " ctermbg=" . "NONE"
    exec "hi makeBString    cterm=NONE   ctermfg=" . <SID>X(44) . " ctermbg=" . "NONE"
    exec "hi makeCommands   cterm=NONE   ctermfg=" . <SID>X(64) . " ctermbg=" . "NONE"
    exec "hi makeConfig	    cterm=NONE   ctermfg=" . <SID>X(66) . " ctermbg=" . "NONE"
    exec "hi makeTarget	    cterm=NONE   ctermfg=" . <SID>X(24) . " ctermbg=" . "NONE"
    exec "hi Structure	    cterm=NONE   ctermfg=" . <SID>X(24) . " ctermbg=" . "NONE"
    exec "hi Exception	    cterm=NONE   ctermfg=" . <SID>X(34) . " ctermbg=" . "NONE"
    exec "hi StorageClass   cterm=NONE   ctermfg=" . <SID>X(40) . " ctermbg=" . "NONE"
    exec "hi Boolean        cterm=NONE   ctermfg=" . <SID>X(49) . " ctermbg=" . "NONE"
    exec "hi cppType	    cterm=NONE   ctermfg=" . <SID>X(47) . " ctermbg=" . "NONE"
    exec "hi Label	    cterm=NONE   ctermfg=" . <SID>X(53) . " ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(57)
    exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(72) . " ctermbg=" . "NONE"
